          ...
          <form class="mt-8 space-y-6  " action="{{ route('login') }}" method="POST">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  class="appearance-none rounded-none relative block w-full px-3 py-2 border mb-6 border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm @error('email') is-invalid @enderror"
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                />
                <label htmlFor="remember_me" class="ml-2 block text-sm text-gray-900">
                 {{ __('Remember Me') }}
                </label>
              </div>
              ...
              <div class="text-sm">
                <a href="#" class="font-medium text-black">
               <Link to="/Forget">   @if (Route::has('password.request'))
