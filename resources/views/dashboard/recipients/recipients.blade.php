   ...
   <style>
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-dark text-base font-semibold pt-4">
            ...
            <a href="{{url('recipients')}}" class=" active-nav-link border-black border-r-4 flex items-center text-dark opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
              ...
              @include('dashboard.recipients.recipients_component_for_show')
